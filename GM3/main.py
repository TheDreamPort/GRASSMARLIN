#!/usr/bin/env python3
"""
This is an example driver file to call GRASSMARLIN as a plugin for other modules
"""
...
def main(args):
    ...
    java_path = args.java
    jar_name = "target/grassmarlin-cli-1.0-SNAPSHOT-jar-with-dependencies.jar"
